  ...
  <div class="form-row">
    ...
    <div class="form-group col-md-4">
      ...
      <div class="form-group">
        ...
        <input type="number" readonly="readonly" class="diskon form-control diskon" name="diskon"
               id="inputBerlaku" value="{{$so->Diskon}}">
      </div>
      <div class="form-group">
        <label for="inputPelanggan">PPn</label>
        <input type="text" readonly="readonly" class="diskon form-control ppn" name="ppn" id="inputBerlaku"
               value="{{$so->PPN}}">
      </div>
    </div>
    <!-- pembatas -->
      ...
      <table id="items">
        ...
        @foreach($items as $key => $data)
          <tr class="rowinput">
            ...
            <td>
              <input type="number" onchange="qty({{$key+1}})" name="qty[]"
                     class="form-control qty{{$key+1}} qtyj" required="" value="{{$data->jml}}">
            ...
            <td>
              <input readonly="" type="text" name="price[]" class="form-control price{{$key+1}}" required=""
            ...
            <td>
              <input readonly="" type="text" name="total[]" class="form-control total{{$key+1}}" required=""
                     value="{{$data->HargaJual * $data->jml}}">
            </td>
          </tr>
        @endforeach
