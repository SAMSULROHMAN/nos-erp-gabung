...
@section('content')
    <div class="container">
        <div class="row">
            <div class="x_panel">
                <form action="{{ route('datapelanggan.update',$pelanggan->KodePelanggan ) }}" method="post">
                    @method('PUT')
                    @csrf
                    <div class="col-md-6">
                        <div class="x_panel">
                            ...
                            <div class="x_body">
                                <div class="form-group">
                                    ...
                                    <input id="KodePelanggan" readonly value="{{ $pelanggan->KodePelanggan }}" class="form-control" type="text" name="KodePelanggan">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="NIK" class="form-control" type="number" name="NPWP" value="{{ $pelanggan->NPWP }}">
                                </div>
                            ...
                            <div class="x_content">
                                <table class="table table-responsive">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <input type="text" name="alamat[]" id="" class="form-control" value="">
                                            </td>
                                            <td>
